...
export const DetectionView: React.FC = () => {
  ...
  const getBarColor = (label: string) => {
    switch (label) {
      ...
      case 'Dysplasia': return '#f59e0b'; // amber-500
      case 'OSCC': return '#ef4444'; // red-500
            ...
            <div className="flex-1">
              ...
              <div className="mb-6">
                ...
                <div className={`text-3xl font-bold ${
                  result.predictedClass === 'OSCC' ? 'text-red-600' :
                  result.predictedClass === 'Dysplasia' ? 'text-amber-600' : 'text-green-600'
                }`}>
              ...
              <div className="h-48 w-full">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart layout="vertical" data={result.probabilities} margin={{ left: 40, right: 20 }}>
                  ...
                  <div>
                    ...
                    <div className="aspect-square bg-slate-100 rounded-lg overflow-hidden border border-slate-200 relative group">
                      ...
                      <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                        <span className="text-white text-xs font-medium">Highlighted Regions</span>
                      </div>
                    </div>
                  </div>
                )}
